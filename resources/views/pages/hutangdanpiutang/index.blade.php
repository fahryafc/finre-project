    ...
    <div class="grid grid-cols-12">
        <div class="col-span-12">
                        ...
                        <tbody>
                            ...
                            @foreach ($hutang as $data)
                                <tr data-kategori="{{ $data->kategori }}" data-status="{{ $data->status }}">
                                    ...
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                        {{ $data->nm_perusahaan }}</td>
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                        {{ $data->kategori }}</td>
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                        {{ 'Rp ' . number_format($data->total_hutang, 0, '.', '.') }}</td>
                                    @if ($data->status == 'Belum Lunas')
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                            <span
                                                class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-500 text-white">{{ $data->status }}</span>
                                        </td>
                                    @else
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                            <span
                                                class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-green-500 text-white">{{ $data->status }}</span>
                                        </td>
                                    @endif
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                        {{ date('d-m-Y', strtotime($data->tgl_jatuh_tempo)) }}</td>
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                        <button type="button"
                                            class="btn rounded-full bg-warning/25 text-warning hover:bg-warning hover:text-white"
                                            data-fc-behavior="static"
                                            data-fc-target="modalHutang{{ $data->id_hutangpiutang }}" data-fc-type="modal"
                                            data-type="hutang" data-id-hutang="{{ $data->id_hutangpiutang }}"
                                            onclick="openDetailHutang(this)">Detail</button>
                                        @if ($data->status == 'Belum Lunas')
                                            <button type="button"
                                                class="btn rounded-full bg-info/25 text-info hover:bg-info hover:text-white"
                                                data-fc-behavior="static"
                                                data-fc-target="modalPelunasanHutang{{ $data->id_hutangpiutang }}"
                                                data-fc-type="modal">Bayar Hutang</button>
                                        @else
                                        @endif
                                    </td>
                                </tr>
            ...
            @foreach ($hutang as $index)
                <div id="modalHutang{{ $index->id_hutangpiutang }}"
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
                            <div>
                                ...
                                <span
                                    class="text-sm text-gray-600 dark:text-gray-400 nmPerusahaan">{{ $index->nm_perusahaan }}</span>
                            </div>
                            <button
                                class="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-full"
                                data-fc-dismiss type="button">
                                <span class="material-symbols-rounded">close</span>
                            </button>
                        </div>

                        <div class="loading-spinner hidden animate-spin inline-block w-6 h-6 border-[3px] border-current border-t-transparent text-primary rounded-full mx-auto mt-4"
                        ...
                        <div class="card-body p-5">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            ...
                                            Pembayaran</th>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nominal
                                            Dibayarkan</th>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Sisa
                                            Pembayaran</th>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Catatan
                                        </th>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Masuk
                                            Akun</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="flex justify-end items-center gap-4 p-4 border-t dark:border-slate-700">
                                <button
                                    class="btn rounded-full bg-danger/25 text-danger hover:bg-danger hover:text-white transition-all"
            ...
            @foreach ($hutang as $data)
                <div id="modalPelunasanHutang{{ $data->id_hutangpiutang }}"
                    class="w-full h-auto max-h-[70vh] mt-5 fixed top-0 left-0 z-50 transition-all duration-500 fc-modal hidden">
                    <div
                        class="max-w-[60rem] fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700">
                        <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
                            ...
                            <ul class="max-w flex flex-col">
                                <li
                                    ...
                                    <div class="flex justify-between w-full">
                                        Nama
                                        <span
                                            class="inline-flex items-center py-1 px-2 rounded-full text-md font-medium bg-[#307487] text-white">{{ $data->nama_kontak }}</span>
                                    </div>
                                </li>
                                <li
                                    class="inline-flex items-center gap-x-2 py-2.5 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                                    <div class="flex justify-between w-full">
                                        Perusahaan
                                        <span
                                            class="inline-flex items-center py-1 px-2 rounded-full text-md font-medium bg-[#307487] text-white">{{ $data->nm_perusahaan }}</span>
                                    </div>
                                </li>
                                <li
                                    class="inline-flex items-center gap-x-2 py-2.5 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                                    <div class="flex justify-between w-full">
                                        Total Hutang
                                        <span
                                            class="inline-flex items-center py-1 px-2 rounded-full text-md font-medium bg-[#307487] text-white">{{ 'Rp ' . number_format($data->total_hutang, 0, '.', '.') }}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <hr class="border-2 border-gray-300 my-2">
                        <form id="" action="{{ route('hutangpiutang.store') }}" method="POST"
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="mb-3">
                                        <label for="tanggal_pembayaran"
                                            ...
                                            Pembayaran</label>
                                        <input type="text" class="form-input" name="tanggal_pembayaran"
                                            id="datepicker-basic">
                                    </div>
                                    <div class="mb-3">
                                        <label for="dibayarkan"
                                            class="text-gray-800 text-sm font-medium inline-block mb-2">Nominal
                                            Pembayaran</label>
                                        <input type="text" class="form-input" id="dibayarkan" name="dibayarkan"
                                            aria-describedby="dibayarkan" placeholder="Masukan Nominal Pembayaran">
                                    </div>
                                    <div class="mb-3">
                                        <label for="masuk_akun"
                                            class="text-gray-800 text-sm font-medium inline-block mb-2"> Akun Tujuan
                                            Pembayaran </label>
                                        <select id="masuk_akun" name="masuk_akun"
                                    ...
                                    <div class="mb-3">
                                        <label for="catatan" name="catatan"
                                            class="text-gray-800 text-sm font-medium inline-block mb-2">Catatan</label>
            ...
            <div class="card mt-10 p-5">
                <div class="card-header mb-5 flex justify-between items-center">
                    ...
                    <div class="filter-container flex flex-row items-center gap-4">
                        <div class="flex flex-col">
                            <label for="filterStatusPiutang" class="text-gray-800 text-sm font-medium mb-1">Filter
                                Status:</label>
                        ...
                        <thead>
                            <tr>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">No</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nama</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Perusahaan</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Kategori</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Piutang
                                </th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Status</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tanggal Jatuh
                                    Tempo</th>
                                <th scope="col"
                                ...
                                <tr data-kategori="{{ $data->kategori }}" data-status="{{ $data->status }}">
                                    ...
                                    <td
                                        ...
                                        <button type="button"
                                            class="btn rounded-full bg-warning/25 text-warning hover:bg-warning hover:text-white"
                                            data-fc-behavior="static"
                                            data-fc-target="riwayatPiutang{{ $data->id_hutangpiutang }}"
                                            data-fc-type="modal" data-type="piutang"
                                            data-id-piutang="{{ $data->id_hutangpiutang }}"
                                            onclick="riwayatPiutang(this)">Detail</button>
                                        @if ($data->status == 'Belum Lunas')
                                            <button type="button"
                                                class="btn rounded-full bg-info/25 text-info hover:bg-info hover:text-white"
                                                data-fc-behavior="static"
                                                data-fc-target="modalPelunasanPiutang{{ $data->id_hutangpiutang }}"
                                                data-fc-type="modal">Bayar Piutang</button>
                                        @else
                                        @endif
                                    </td>
                                </tr>
            ...
            @foreach ($piutang as $index)
                <div id="riwayatPiutang{{ $index->id_hutangpiutang }}"
                    class="w-full h-auto max-h-[70vh] mt-5 fixed top-0 left-0 z-50 transition-all duration-500 fc-modal hidden">
                    <div
                        class="max-w-[60rem] fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700">
                        <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
            ...
            @foreach ($piutang as $data)
                <div id="modalPelunasanPiutang{{ $data->id_hutangpiutang }}"
                    class="w-full h-auto max-h-[70vh] mt-5 fixed top-0 left-0 z-50 transition-all duration-500 fc-modal hidden">
                    <div
                        class="max-w-[60rem] fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700">
                        <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="mb-3">
                                        <label for="tanggal_pembayaran"
                                            class="text-gray-800 text-sm font-medium inline-block mb-2">Tanggal
                                            Pembayaran</label>
                                        <input type="date" class="form-input" name="tanggal_pembayaran"
                                            id="datepicker-basic">
                                    </div>
                                    <div class="mb-3">
                                        <label for="dibayarkan"
                                            class="text-gray-800 text-sm font-medium inline-block mb-2">Nominal
                                            Pembayaran</label>
                                        <input type="text" class="form-input" id="piutang_dibayarkan"
                                            name="dibayarkan" aria-describedby="dibayarkan"
...
@section('script')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const inputPembayaranPiutang = document.querySelectorAll(
                "input[id^='piutang_dibayarkan']"); // Ambil semua input
            ...
            inputPembayaranPiutang.forEach((input) => {
            ...
            function prepareForSubmit() {
                ...
                const nominalPiutang = document.querySelectorAll("input[id^='piutang_dibayarkan']");

                if (nominal) {
                    nominal.value = parseRupiahToNumber(nominal.value);
                }

                nominalPiutang.forEach((input) => {
                    input.value = parseRupiahToNumber(input.value);
                });
            }

            // Tambahkan event listener ke semua form untuk memastikan nilai bersih sebelum submit
