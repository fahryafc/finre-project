                        ...
                        <div class="mb-3">
                            ...
                            <select id="pemasok" name="pemasok"
                                ...
                                @foreach ($pemasoks as $pemasok)
                                    <option value="{{ $pemasok->nama_kontak }}"
                                        {{ old('pemasok', $asset->pemasok) == $pemasok->id_kontak ? 'selected' : '' }}>
                                        {{ $pemasok->nama_kontak }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-input" id="nm_aset" name="nm_aset"
                                aria-describedby="nm_aset" placeholder="Masukan Nama Asset" value="{{ $asset->nm_aset }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <select id="satuan" name="satuan"
                                ...
                                @foreach ($satuan as $satuans)
                                    <option value="{{ $satuans->nama_satuan }}"
                                        {{ old('satuan', $asset->satuan) == $satuans->nama_satuan ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="kategori" name="kategori"
                                ...
                                @foreach ($kategori as $ktg)
                                    <option value="{{ $ktg->nama_kategori }}"
                                        {{ old('kategori', $asset->kategori) == $ktg->nama_kategori ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-input" id="kode_sku" name="kode_sku"
                                aria-describedby="kode_sku" placeholder="Masukan Kode/SKU" value="{{ $asset->kode_sku }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <select id="akun_pembayaran" name="akun_pembayaran"
                                ...
                                @foreach ($kasdanbank as $kasbank)
                                    <option value="{{ $kasbank->kode_akun }}"
                                        @if ($asset->akun_pembayaran == $kasbank->kode_akun) selected @endif>
                            ...
                            <select id="akun_aset" name="akun_aset"
                                ...
                                @foreach ($akun as $akuns)
                                    <option value="{{ $akuns->kode_akun }}"
                                        {{ old('akun_aset', $asset->akun_aset) == $akuns->kode_akun ? 'selected' : '' }}>
                                        <span class="flex justify-between w-full">
                        ...
                        <div class="mb-3 flex items-center">
                            <input type="checkbox" id="penyusutan" name="penyusutan" class="form-switch text-primary"
                                ...
                                @if ($asset->penyusutan != 0) checked @endif>
                        ...
                        <div class="mb-3 flex items-center">
                            <input type="checkbox" id="pajakButton" name="pajakButton" class="form-switch text-primary"
                                ...
                                @if ($asset->pajak != 0) checked @endif>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-3">
                            <div class="mb-3">
                                ...
                                <select id="jns_pajak" name="jns_pajak"
                                    ...
                                    <option value="ppn11" @if ($asset->jns_pajak == 'ppn11') selected @endif>PPN (11%)
                                    </option>
                                    <option value="ppn12" @if ($asset->jns_pajak == 'ppn12') selected @endif>PPN (12%)
                                    </option>
                                    <option value="ppnbm" @if ($asset->jns_pajak == 'ppnbm') selected @endif>PPnBM</option>
                                </select>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                    ...
                                    placeholder="Pajak Dibayarkan" readonly value="{{ $asset->pajak_dibayarkan }}">
                            </div>
                        </div>
                        <!-- end row collapse -->
                        <hr class="border-2 border-gray-300 my-4"> <!-- Garis pemisah -->
...
@section('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const pajakCheckbox = document.getElementById("pajakButton");

            if (pajakCheckbox.checked) {
                toggleCollapsePajak(); // Panggil fungsi saat halaman dimuat jika checked
            }

            const penyusutanCheckbox = document.getElementById("penyusutan");
            if (penyusutanCheckbox.checked) {
                toggleCollapseWithSwitch(); // Panggil fungsi saat halaman dimuat jika checked
            }
        });
    </script>
@endsection
