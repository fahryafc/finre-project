            ...
            <div class="p-6">
                <form action="{{ route('penjualan-asset.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="mb-3">
                            <label for="id_kontak" class="text-gray-800 text-sm font-medium inline-block mb-2">Nama
                                Pelanggan</label>
                            <select id="id_kontak" name="id_kontak"
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="mb-3">
                            <label for="tanggal" class="text-gray-800 text-sm font-medium inline-block mb-2">Tanggal
                                Pembelian</label>
                            <input type="text"
                                class="form-input bg-gray-300 text-gray-500 cursor-not-allowed tgl_pembelian" name="tanggal"
                                id="datepicker-basic" value="{{ \Carbon\Carbon::parse($asset->tanggal)->format('d-m-Y') }}"
                                data-tanggal="{{ \Carbon\Carbon::parse($asset->tanggal)->format('d-m-Y') }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="tgl_penjualan" class="text-gray-800 text-sm font-medium inline-block mb-2">Tanggal
                                Penjualan</label>
                            <input type="text" class="form-input tgl_penjualan" name="tgl_penjualan"
                                id="datepicker-basic" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                id="harga_beli" name="harga_beli" placeholder="Masukan Harga Beli"
                                value="{{ 'Rp. ' . number_format(old('harga_beli', $asset->harga_beli, 0, '.', '.')) }}"
                                readonly>
                        </div>
                        <div class="mb-3">
                            <label for="kuantitas"
                                class="text-gray-800 text-sm font-medium inline-block mb-2">Kuantitas</label>
                            <input type="text" class="form-input" id="kuantitas" name="kuantitas"
                                placeholder="Masukan Kuantitas" value="{{ old('kuantitas', $asset->kuantitas) }}"
                                data-max-kuantitas="{{ $asset->kuantitas }}">
                        </div>
                        <div class="mb-3">
                            <label for="total_nilai_asset" class="text-gray-800 text-sm font-medium inline-block mb-2">Total
                                Nilai Asset</label>
                            <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                id="total_nilai_asset" name="total_nilai_asset" placeholder="Total Nilai Asset"
                                value="{{ 'Rp. ' . number_format(old('total_nilai_asset', $asset->harga_beli * $asset->kuantitas, 0, '.', '.')) }}"
                                readonly>
                        </div>
                    </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                <input type="text" id="nominal_deposit" name="nominal_deposit"
                                                    class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                                    value="Rp. 0">
                                            </td>
                                        </tr>
