...
@section('content')
            ...
            <div class="card-header">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <button class="btn bg-[#307487] text-white" data-fc-target="tambahAsset" data-fc-type="modal"
                            type="button">
                                                ...
                                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                                    ...
                                                    @foreach ($asset as $ast)
                                                        <tr class="hover:bg-gray-200 dark:hover:bg-gray-700">
                                                            ...
                                                            <td
                                                                class="asset-name px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200 cursor-pointer hover:text-blue-600 hover:underline">
                                                                <button class="cursor-pointer"
                                                                    data-fc-target="modalDetailAsset" data-fc-type="modal"
                                                                    data-asset-id="{{ $ast->id_aset }}">
                                                                    {{ $ast->nm_aset }}
                                                                </button>
                                                            </td>
                                                            <td
                                                            ...
                                                            <td
                                                                ...
                                                                @php
                                                                    ...
                                                                    $tanggalPenyusutan = \Carbon\Carbon::parse(
                                                                        $ast->tanggal_penyusutan,
                                                                    );
                                                                    // Hitung selisih tahun antara tanggal sekarang dengan tanggal penyusutan
                                                                    $tahunBerjalan = \Carbon\Carbon::now()->diffInYears(
                                                                        $tanggalPenyusutan,
                                                                    );
                                                                    ...
                                                                    if ($ast->penyusutan == 1) {
                                                                        if (
                                                                            !is_null($ast->masa_manfaat) &&
                                                                            $ast->masa_manfaat > 0
                                                                        ) {
                                                                            // Jika masa manfaat terisi
                                                                            $persentaseDepresiasiTahunan =
                                                                                100 / $ast->masa_manfaat;
                                                                            $persentaseAkumulasi =
                                                                                $tahunBerjalan *
                                                                                $persentaseDepresiasiTahunan;
                                                                        } elseif (
                                                                            !is_null($ast->nilai_tahun) &&
                                                                            $ast->nilai_tahun > 0
                                                                        ) {
                                                                            // Jika nilai tahun terisi
                                                                            $persentaseAkumulasi =
                                                                                $ast->nilai_tahun * $tahunBerjalan;
                                                                        }

                                                                        // Pastikan persentase akumulasi tidak melebihi 100%
                                                                        $persentaseAkumulasi = min(
                                                                            $persentaseAkumulasi,
                                                                            100,
                                                                        );
                                                                    }
                                                            ...
                                                            <td
                                                                ...
                                                                <div class="flex items-center justify-end space-x-2">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-id="{{ $ast->id_aset }}"
                                                                        data-fc-target="modalJualAset"
                                                                        data-fc-type="modal"
                                                                        onclick="loadAssetData(this)">
                                                                        <i
                                                                            class="ti ti-credit-card-pay text-base me-1"></i>
                                                                        Jual
                                                                    </button>

                                                                    <!-- Edit Button -->
                                                                    <button
                                                                        class="btn rounded-full bg-[#307487]/25 text-primary hover:bg-[#307487] hover:text-white"
                                                                        data-fc-target="modalEditAsset"
                                                                    ...
                                                                    <!-- Delete Form & Button -->
                                                                    <form
                                                                        action="{{ route('asset.destroy', $ast->id_aset) }}"
                                                                        method="POST" class="inline delete-form">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
                                                                            class="btn rounded-full bg-danger/25 text-danger hover:bg-danger hover:text-white delete-btn"
                                                                            data-id="{{ $ast->id_aset }}"
                                                                            data-image-url="{{ asset('images/confirm-delete.png') }}">
                                                                            <i
                                                                                class=" mgc_delete_2_line text-base me-1"></i>
                                                                            Delete
                                                                        </button>
                                                                    </form>
                                                                </div>
                                                            ...
                                                            <td
                                                                ...
                                                                @php
                                                                    ...
                                                                    if ($terjual->penyusutan == 1) {
                                                                        if (
                                                                            !is_null($terjual->masa_manfaat) &&
                                                                            $terjual->masa_manfaat > 0
                                                                        ) {
                                                                            // Jika masa manfaat terisi
                                                                            $persentaseDepresiasiTahunan =
                                                                                100 / $terjual->masa_manfaat;
                                                                            $persentaseAkumulasi =
                                                                                $tahunBerjalan *
                                                                                $persentaseDepresiasiTahunan;
                                                                        } elseif (
                                                                            !is_null($terjual->nilai_tahun) &&
                                                                            $terjual->nilai_tahun > 0
                                                                        ) {
                                                                            // Jika nilai tahun terisi
                                                                            $persentaseAkumulasi =
                                                                                $terjual->nilai_tahun * $tahunBerjalan;
                                                                        }
    ...
    <!-- Modal Detail Asset -->
    <div id="modalDetailAsset"
        class="w-full h-auto max-h-[70vh] mt-5 fixed top-0 left-0 z-50 transition-all duration-500 fc-modal hidden">
        <div
            class="max-w-[60rem] fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700">
            <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
                ...
                <div class="flex items-center">
                    <button data-fc-type="dropdown" type="button"
                        class="py-2 px-3 inline-flex justify-center items-center rounded-md font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 transition-all text-sm dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white">
                    ...
                    @foreach ($asset as $ast)
                        <div
                            ...
                            <a class="flex items-center py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-[#307487] hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                href="#">
                                Edit
                            </a>
                            <button
                                class="flex items-center py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-[#307487] hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
            ...
            <div class="penyusutan-container flex flex-col gap-3 px-4 py-4 overflow-y-auto">
                <div class="grid grid-cols-4 items-center gap-6">
                    <label for="nm_asset" class="text-gray-800 text-sm font-medium inline-block mb-2">Tanggal
                        Penyusutan</label>
                    <div class="md:col-span-3">
                ...
                <div class="grid grid-cols-4 items-center gap-6">
                    <label for="metode_penyusutan" class="text-gray-800 text-sm font-medium inline-block mb-2">Metode
                        Penyusutan</label>
                    <div class="md:col-span-3">
                ...
                <div class="grid grid-cols-4 items-center gap-6">
                    <label for="nilai_penyusutan" class="text-gray-800 text-sm font-medium inline-block mb-2">Nilai
                        Penyusutan</label>
                    <div class="md:col-span-3">
            ...
            <form action="{{ route('asset.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="px-4 py-4 overflow-y-auto max-h-[60vh]">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="mb-3">
                            <label for="satuan"
                                class="text-gray-800 text-sm font-medium inline-block mb-2">Satuan</label>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="kategori" name="satuan"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input type="checkbox" id="penyusutan" name="penyusutan"
                                    class="form-switch text-primary" value="1"
                                    onchange="toggleCollapseWithSwitch()">
                    ...
                    <div id="collapsePajak" class="hidden w-full overflow-hidden transition-[height] duration-300 mt-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-3">
                            ...
                            <div class="mb-3">
                                <label for="pajak" class="text-gray-800 text-sm font-medium inline-block mb-2">Pajak
                                    (%)</label>
                                <input type="text" class="form-input" id="pajak" name="pajak"
                                    aria-describedby="pajak" placeholder="Masukan Pajak (%)">
                            </div>
                            <div class="mb-3">
                            ...
                            <div>
                                <div class="mb-3">
                                    <label for="tanggal_penyusutan"
                                        ...
                                        Penyusutan</label>
                                    <input type="text" class="form-input" name="tanggal_penyusutan"
                                        id="datepicker-basic">
                                </div>
                            </div>
                        </div>
            ...
            <div
                ...
                <form action="{{ route('asset.update', $ast->id_aset) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="px-4 py-4 overflow-y-auto max-h-[60vh]">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                <div class="mb-3">
                                    <label for="pemasok"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Pemasok</label>
                                    <input type="text" class="form-input" id="pemasok" name="pemasok"
                                        aria-describedby="pemasok" placeholder="Masukan Nama Pemasok"
                                        value="{{ old('pemasok', $ast->pemasok) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="no_hp" class="text-gray-800 text-sm font-medium inline-block mb-2">No
                                        Handphone</label>
                                    <input type="number" class="form-input" id="no_hp" name="no_hp"
                                        aria-describedby="no_hp" placeholder="Masukan No Handphone"
                                        value="{{ old('no_hp', $ast->no_hp) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="nm_perusahaan"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Nama Perusahaan</label>
                                    <input type="text" class="form-input" id="nm_perusahaan" name="nm_perusahaan"
                                        aria-describedby="nm_perusahaan" placeholder="Masukan Nama Perusahaan"
                                        value="{{ old('nm_perusahaan', $ast->nm_perusahaan) }}">
                                </div>
                                <div class="mb-e">
                                    <label for="email"
                                    ...
                                    <input type="email" class="form-input" id="email" name="email"
                                        ...
                                        value="{{ old('email', $ast->email) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="alamat" name="alamat"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Alamat</label>
                                    <textarea id="alamat" name="alamat" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Masukan Alamat"> {{ old('alamat', $ast->alamat) }}</textarea>
                                </div>
                            </div>
                            <!-- Kolom 2 -->
                            <div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="satuan" name="satuan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="" {{ $ast->satuan == '' ? 'selected' : '' }}>-- Pilih Jenis
                                            Satuan --</option>
                                        @foreach ($satuan as $satuans)
                                            <option value="{{ $satuans->nama_satuan }}"
                                                {{ $ast->satuan == $satuans->nama_satuan ? 'selected' : '' }}>
                                                {{ $satuans->nama_satuan }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-input" id="kuantitas" name="kuantitas"
                                        aria-describedby="kuantitas" placeholder="Masukan Kuantitas"
                                        value="{{ old('kuantitas', $ast->kuantitas) }}">
                                </div>
                            </div>
                            <!-- kolom 3 -->
                            <div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-input" id="kode_sku" name="kode_sku"
                                        aria-describedby="kode_sku" placeholder="Masukan Kode/SKU"
                                        value="{{ old('kode_sku', $ast->kode_sku) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="harga_beli"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Harga Beli</label>
                                    <input type="text" class="form-input" id="harga_beli" name="harga_beli"
                                        aria-describedby="harga_beli" placeholder="Masukan Harga Beli"
                                        value="{{ old('harga_beli', $ast->harga_beli) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="akun_pembayaran"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Dibayarkan dari
                                        akun</label>
                                    <select id="akun_pembayaran" name="akun_pembayaran"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="" {{ $ast->akun_pembayaran == '' ? 'selected' : '' }}>--
                                            Pilih Pembayaran --</option>
                                        @foreach ($kasdanbank as $kasbank)
                                            <option value="{{ $kasbank->kode_akun }}"
                                                {{ $ast->akun_pembayaran == $kasbank->kode_akun ? 'selected' : '' }}>
                                                <span class="flex justify-between w-full">
                                                    <span>{{ $kasbank->nama_akun }}</span>
                                                    <span> - </span>
                                                    <span>{{ $kasbank->kode_akun }}</span>
                                ...
                                <div class="mb-3">
                                    <label for="akun_aset"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Akun Aset</label>
                                    <select id="akun_aset" name="akun_aset"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="" {{ $ast->akun_aset == '' ? 'selected' : '' }}>-- Pilih Akun
                                            Asset --</option>
                                        @foreach ($akun as $akuns)
                                            <option value="{{ $akuns->kode_akun }}"
                                                {{ $ast->akun_aset == $akuns->kode_akun ? 'selected' : '' }}>
                                                <span class="flex justify-between w-full">
                                                    <span>{{ $akuns->nama_akun }}</span>
                                                </span>
                                            </option>
                                ...
                                <div class="mb-3">
                                    <div class="flex items-center">
                                        <input type="checkbox" id="penyusutan1" name="penyusutan1"
                                            class="form-switch text-primary" value="1"
                                            onchange="toggleCollapseWithSwitch1()"
                                            {{ $ast->penyusutan == 1 ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="mb-3">
                                        <div class="flex items-center">
                                            <input type="checkbox" id="pajakButton1" name="pajakButton1"
                                                class="form-switch text-primary" value="1"
                                                onchange="toggleCollapsePajak1()" {{ $ast->pajak == 1 ? 'checked' : '' }}>
                        ...
                        <!-- collapse pajak -->
                        <div id="collapsePajak1"
                            class="{{ $ast->pajak == 1 ? '' : 'hidden' }}hidden w-full overflow-hidden transition-[height] duration-300 mt-5">
                            <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
                                <h3 class="font-medium text-gray-800 dark:text-white text-lg">
                                    Pajak
                                </h3>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-3">
                                <div class="mb-3">
                                    <label for="jns_pajak"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Jenis Pajak</label>
                                    <select id="jns_pajak" name="jns_pajak"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="" selected>-- Pilih Jenis Pajak --</option>
                                        <option value="ppn">PPN</option>
                                ...
                                <div class="mb-3">
                                    <label for="pajak_dibayarkan"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Pajak
                                        Dibayarkan</label>
                                    <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                        id="pajak_dibayarkan" name="pajak_dibayarkan" aria-describedby="pajak_dibayarkan"
                                        placeholder="Pajak Dibayarkan" readonly>
                        ...
                        <!-- row kedua: collapse penyusutan-->
                        <div id="collapseWithTarget1"
                            class="{{ $ast->penyusutan == 1 ? '' : 'hidden' }}hidden w-full overflow-hidden transition-[height] duration-300 mt-5">
                            <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
                                <h3 class="font-medium text-gray-800 dark:text-white text-lg">
                                    Penyusutan
                                </h3>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <div class="flex">
                                            <input type="number" class="form-input" id="masa_manfaat"
                                                name="masa_manfaat" aria-describedby="masa_manfaat"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                                <div>
                                    <div class="mb-3">
                                        <label for="akun_penyusutan"
                                            class="text-gray-800 text-sm font-medium inline-block mb-2">Akun
                                            Penyusutan</label>
                                        <select id="akun_penyusutan" name="akun_penyusutan"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option value="" selected>-- Pilih Akun --</option>
                ...
                <div class="px-4 py-4 overflow-y-auto max-h-[60vh]">
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <div class="mb-3">
                                <label for="nm_pelanggan"
                                    class="text-gray-800 text-sm font-medium inline-block mb-2">Pelanggan</label>
                                <input type="text" class="form-input" id="nm_pelanggan" name="nm_pelanggan"
                                    aria-describedby="nm_pelanggan" placeholder="Masukan Nama Pelanggan">
                            </div>
                            <div class="mb-3">
                                <label for="no_hp" class="text-gray-800 text-sm font-medium inline-block mb-2">No
                                    Handphone</label>
                        ...
                        <div>
                            <div class="mb-3">
                                <label for="gender"
                                    class="text-gray-800 text-sm font-medium inline-block mb-2">Gender</label>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="mb-3">
                            <label for="tanggal" class="text-gray-800 text-sm font-medium inline-block mb-2">Tanggal
                                Pembelian</label>
                            <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                name="tanggal" id="datepicker-basic" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="tgl_penjualan" class="text-gray-800 text-sm font-medium inline-block mb-2">Tanggal
                                Penjualan</label>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div class="mb-3">
                            <label for="harga_beli" class="text-gray-800 text-sm font-medium inline-block mb-2">Harga
                                Beli</label>
                            <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                id="harga_beli_aset" name="harga_beli" placeholder="Masukan Harga Beli" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="kuantitas"
                                class="text-gray-800 text-sm font-medium inline-block mb-2">Kuantitas</label>
                            <input type="text" class="form-input" id="jumlah" name="kuantitas"
                                placeholder="Masukan Kuantitas">
                        </div>
                        <div class="mb-3">
                            <label for="total_nilai_asset"
                                class="text-gray-800 text-sm font-medium inline-block mb-2">Total Nilai Asset</label>
                            <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                id="total_nilai_asset" name="total_nilai_asset" placeholder="Total Nilai Asset" readonly>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="mb-3">
                            <label for="harga_pelepasan" class="text-gray-800 text-sm font-medium inline-block mb-2">Harga
                                Pelepasan</label>
                            <input type="text" class="form-input" id="harga_pelepasan" name="harga_pelepasan"
                                placeholder="Masukan Harga Pelepasan">
                        </div>
                        <div class="mb-3">
                            <label for="nilai_penyusutan_terakhir"
                                class="text-gray-800 text-sm font-medium inline-block mb-2">Total Nilai Penyusutan</label>
                            <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                id="nilai_penyusutan_terakhir" name="nilai_penyusutan_terakhir"
                                placeholder="Total Nilai Penyusutan" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="mb-3">
                            <div class="flex items-center">
                                <input type="checkbox" id="buttonPajakPenjualan" name="buttonPajakPenjualan"
                                    class="form-switch text-primary" value="1"
                                    onchange="toggleCollapsePajakPenjualan()">
                    ...
                    <div id="collapsePajakPenjualan"
                        ...
                        <div class="grid grid-cols-4 gap-4 mb-4">
                            <div class="mb-3">
                                <label for="jns_pajak_penjualan"
                                    class="text-gray-800 text-sm font-medium inline-block mb-2">Jenis Pajak</label>
                                <select id="jns_pajak_penjualan" name="jns_pajak_penjualan"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="" selected>-- Pilih Jenis Pajak --</option>
                                    <option value="ppn">PPN</option>
                                    <option value="ppnbm">PPnBM</option>
                            ...
                            <div class="mb-3">
                                <label for="pajak_penjualan"
                                    class="text-gray-800 text-sm font-medium inline-block mb-2">Pajak (%)</label>
                                <input type="text" class="form-input" id="pajak_penjualan" name="pajak_penjualan"
                                    aria-describedby="pajak" placeholder="Masukan Pajak (%)">
                            </div>
                            <div class="mb-3">
                                <label for="pajak_penjualan_dibayarkan"
                                    class="text-gray-800 text-sm font-medium inline-block mb-2">Pajak Dibayarkan</label>
                                <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                    id="pajak_penjualan_dibayarkan" name="pajak_penjualan_dibayarkan"
                                    aria-describedby="pajak_penjualan_dibayarkan" placeholder="Pajak Dibayarkan" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="akun_pajak_penjualan"
                                    class="text-gray-800 text-sm font-medium inline-block mb-2">Akun Pajak</label>
                                <select id="akun_pajak_penjualan" name="akun_pajak_penjualan"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr>
                                            ...
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                <input type="text" id="nilai_buku" name="nilai_buku"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                <input type="text" id="hargaPelepasanDisplay" name="nominal_deposit"
                                                    class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                                    value="Rp. 0">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                Keuntungan / Kerugian </td>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                <select id="akun_keuntungan_kerugian" name="akun_keuntungan_kerugian"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <option value="" selected>-- Akun --</option>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                <input type="text" id="keuntungan_kerugian"
                                                    name="nominal_keuntungan_kerugian"
                                                    class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                                    value="Rp. 0">
                                            </td>
                                        </tr>
    ...
    <div id="tambahKategori"
        ...
        <div
            class="sm:max-w-2xl fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700">
            <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
                <h3 class="font-medium text-gray-800 dark:text-white text-lg">
                    Tambah Kategori
                </h3>
                        ...
                        <div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-input" id="nama_kategori" name="nama_kategori"
                                    aria-describedby="nama_kategori" placeholder="Masukan Nama Kategori">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        ...
        function parseRupiahToNumber(rupiah) {
            return parseInt(rupiah.replace(/[^,\d]/g, '').replace(',', '')) ||
            0; // Hapus karakter selain angka dan konversi ke integer
        }
        ...
        function hitungPajakDibayarkan() {
            ...
            pajakDibayarkanInput.value = formatRupiah(totalPajakDibayarkan
        .toString()); // Tampilkan hasil format dalam rupiah
        }
            ...
            fetch(`/get-asset-data/${idAset}`)
                ...
                .then(data => {
                    ...
                    function calculateProfitLoss() {
                        ...
                        document.getElementById('total_nilai_asset').value = formatRupiah(totalNilaiAssetBaru
                        .toString());
                        document.getElementById('nilai_buku').value = formatRupiah(nilaiBukuBaru.toString());
                        document.getElementById('nilai_penyusutan_terakhir').value = formatRupiah(totalPenyusutanBaru
                            .toString());
                    }
                    ...
                    document.getElementById('nilai_penyusutan_terakhir').value = formatRupiah(totalPenyusutanTerakhir
                        .toString());
                ...
                button.addEventListener('click', function() {
                    ...
                    fetch(`/get-asset-detail/${assetId}`)
                        ...
                        .then(data => {
                            ...
                            if (data.asset) {
                                document.querySelector('.nm_asset').textContent =
                                    `: ${data.asset.nm_aset}`;
                                document.querySelector('.kode').textContent =
                                    `: ${data.asset.kode_sku}`;
                                document.querySelector('.tanggal').textContent =
                                    `: ${data.asset.tanggal}`;
                                document.querySelector('.harga_beli').textContent =
                                    `: ${formatRupiah(data.asset.harga_beli).toString()}`;
                                document.querySelector('.kuantitas').textContent =
                                    `: ${data.asset.kuantitas}`;
                            }
                            ...
                            const tanggalPenjualan = new Date(data.penyusutan
                                .tanggal_penyusutan);
                            const tanggalSekarang = new Date();

                            const tahunBerjalan = tanggalSekarang.getFullYear() -
                                tanggalPenjualan.getFullYear();

                            let nilaiDepresiasiPerTahun = 0;
                            let penyusutanPerUnit = 0;

                            if (data.asset.penyusutan == 1) {
                                if (data.penyusutan.masa_manfaat !== null && data.penyusutan
                                    .masa_manfaat !== '') {
                                    nilaiDepresiasiPerTahun = data.penyusutan
                                        .nominal_masa_manfaat;
                                    penyusutanPerUnit = nilaiDepresiasiPerTahun / kuantitasAwal;
                                } else if (data.penyusutan.nilai_tahun !== null && data
                                    .penyusutan.nilai_tahun !== '') {
                                    nilaiDepresiasiPerTahun = data.penyusutan
                                        .nominal_nilai_tahun;
                                    penyusutanPerUnit = nilaiDepresiasiPerTahun / kuantitasAwal;
                                }
                            ...
                            const penyusutanPerUnitBerjalan = penyusutanPerUnit * tahunBerjalan;
                            const totalPenyusutanTerakhir = penyusutanPerUnitBerjalan *
                                kuantitasAwal;

                            // Nilai buku saat ini setelah depresiasi
                            let nilaiBukuSaatIni = totalNilaiAssetAwal -
                            totalPenyusutanTerakhir;

                            // Tampilkan informasi nilai buku pada modal detail
                            document.querySelector('.nilai_buku').textContent =
                                `: ${formatRupiah(nilaiBukuSaatIni.toString())}`;

                            // Tampilkan informasi penyusutan hanya jika `penyusutan` bernilai `1`
                            if (data.asset.penyusutan == 1) {
                                document.querySelector('.tanggal_penyusutan').textContent =
                                    `: ${data.penyusutan.tanggal_penyusutan}`;
                                if (data.penyusutan.masa_manfaat !== null && data.penyusutan
                                    .masa_manfaat !== '') {
                                    document.querySelector('.metode_penyusutan').textContent =
                                        `: Masa Manfaat - ${data.penyusutan.masa_manfaat} Tahun`;
                                    document.querySelector('.nilai_penyusutan').textContent =
                                        `: ${formatRupiah(data.penyusutan.nominal_masa_manfaat).toString()}`;
                                }
                                if (data.penyusutan.nilai_tahun !== null && data.penyusutan
                                    .nilai_tahun !== '') {
                                    document.querySelector('.metode_penyusutan').textContent =
                                        `: Nilai/Tahun - ${data.penyusutan.nilai_tahun}%`;
                                    document.querySelector('.nilai_penyusutan').textContent =
                                        `: ${formatRupiah(data.penyusutan.nominal_nilai_tahun).toString()}`;
                                }
                            }

                            // Tampilkan modal
                            document.getElementById('modalDetailAsset').classList.remove(
                                'hidden');
                        });
                });
            });
