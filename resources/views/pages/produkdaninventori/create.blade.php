            ...
            <form id="createProduk" action="{{ route('produkdaninventori.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-input" id="kuantitas" name="kuantitas" placeholder="Masukan Kuantitas" >
                    </div>
                    <div class="mb-3">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-input" id="harga_beli" name="harga_beli" placeholder="Masukan Harga Beli" >
                    </div>
                    <div class="mb-3">
                        <label for="harga_jual" class="text-gray-800 text-sm font-medium inline-block mb-2">Harga Jual</label>
                        <input type="text" class="form-input" id="harga_jual" name="harga_jual" placeholder="Masukan Harga Jual">
                    </div>
                </div>
                <hr class="border-2 border-gray-300 my-2">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="mb-3" id="pajakPersenContainer">
                        ...
                        <input type="text" class="form-input" id="pajak_persen" name="pajak_persen" aria-describedby="pajak_persen" placeholder="Masukan Pajak (%)">
                    </div>
                    <div class="mb-3">
                        <label for="nominal_pajak" class="text-gray-800 text-sm font-medium inline-block mb-2">Nominal Pajak (Rp)</label>
                        <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed" id="nominal_pajak" name="nominal_pajak" aria-describedby="nominal_pajak" placeholder="Nominal Pajak" readonly>
                    </div>
                </div>
                <hr class="border-2 border-gray-300 my-2">
...
<!-- Modal Tambah Kontak -->
<div id="kategoriModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="kategoriModal" data-modal-hide="kategoriModal">
