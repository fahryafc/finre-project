...
@section('content')
    <div class="col-span-2">
        <div class="card">
            ...
            <div class="p-6">
                <form id="createProduk" action="{{ route('produkdaninventori.update', $produk->id_produk) }}" method="POST"
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-input tgl_edit" name="tanggal" id="datepicker-basic"
                                value="{{ old('tanggal', $produk->tanggal) }}" data-tanggal="{{ $produk->tanggal }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-input" id="kuantitas" name="kuantitas" required
                                placeholder="Masukan Kuantitas" value="{{ old('kuantitas', $produk->kuantitas) }}">
                        </div>
                        <div class="mb-3">
                            <label for="kode_sku"
                            ...
                            <input type="text" class="form-input" id="kode_sku" name="kode_sku"
                                ...
                                value="{{ old('kode_sku', $produk->kode_sku) }}">
                        </div>
                    </div>
                    <hr class="border-2 border-gray-300 my-2">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-input" id="harga_beli" name="harga_beli"
                                ...
                                value="{{ old('harga_beli', 'Rp ' . number_format($produk->harga_beli, 0, ',', '.')) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-input" id="harga_jual" name="harga_jual" required
                                ...
                                value="{{ old('harga_beli', 'Rp ' . number_format($produk->harga_jual, 0, ',', '.')) }}">
                        </div>
                    </div>
                    <hr class="border-2 border-gray-300 my-2">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="mb-3">
                            ...
                            <select id="jns_pajak" name="jns_pajak"
                                ...
                                <option value="ppn" {{ strtoupper($produk->jns_pajak) == 'PPN' ? 'selected' : '' }}>PPN
                                </option>
                                <option value="ppnbm" {{ strtoupper($produk->jns_pajak) == 'PPNBM' ? 'selected' : '' }}>
                                    PPnBM
                                </option>
                            </select>
                        </div>
                        <div class="mb-3" id="pajakPersenContainer">
                            ...
                            <input type="text" class="form-input" id="pajak_persen" name="pajak_persen"
                                ...
                                value="{{ old('pajak_persen', $produk->persen_pajak) }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-input bg-gray-300 text-gray-500 cursor-not-allowed"
                                ...
                                value="{{ 'Rp. ' . number_format(old('nominal_pajak', $produk->nominal_pajak, 0, '.', '.')) }}"
                                readonly>
                        </div>
                    </div>
                    <hr class="border-2 border-gray-300 my-2">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="mb-3">
                            ...
                            <select id="akun_pembayaran" class="selectize-search" name="akun_pembayaran">
                                @foreach ($akun as $key)
                                    <option value="{{ $key->kode_akun }}"
                        ...
                        <div class="mb-3">
                            <div class="flex w-full">
                                ...
                                <input type="text"
                                    ...
                                    style="color: white;" id="total_transaksi" name="total_transaksi"
                                    value="{{ 'Rp. ' . number_format(old('total_transaksi', $produk->total_transaksi, 0, '.', '.')) }}"
                                    readonly>
                            </div>
                        </div>
                    </div>
