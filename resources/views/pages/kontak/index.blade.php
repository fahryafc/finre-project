...
@section('content')
        ...
        <div class="card">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="flex-grow text-right">
                        <h3 class="text-gray-700 mt-1 text-3xl font-bold dark:text-gray-300">{{ $totals->total_pelanggan }}
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="flex-grow text-right">
                        <h3 class="text-gray-700 mt-1 text-3xl font-bold dark:text-gray-300">{{ $totals->total_karyawan }}
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="flex-grow text-right">
                        <h3 class="text-gray-700 mt-1 text-3xl font-bold dark:text-gray-300">{{ $totals->total_vendor }}
                        </h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <div
                            ...
                            <a class="flex items-center py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-[#307487] hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                href="{{ route('export.kontak') }}">
                                Excel
                            </a>
                            <a class="flex items-center py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-[#307487] hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                href="{{ route('export.kontak.pdf') }}">
                                PDF
                            </a>
                        </div>
                        <button class="btn bg-[#307487] text-white" data-fc-target="tambahKontak" data-fc-type="modal"
                            type="button">
                                        ...
                                        @foreach ($kontak as $kontaks)
                                            <tr>
                                                <td
                                                    ...
                                                    {{ $counter + ($kontak->currentPage() - 1) * $kontak->perPage() }}</td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                    {{ $kontaks->nama_kontak }}
                                                </td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                    <form action="{{ route('kontak.destroy', $kontaks->id_kontak) }}"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-fc-target="editKontak{{ $kontaks->id_kontak }}"
                                                        data-fc-type="modal"><i class="mgc_edit_2_line"></i></button>
                                                </td>
                                            </tr>
                                            @php $counter++; @endphp
                                        @endforeach
    ...
    <!-- Modal Edit Kontak -->
    @foreach ($kontak as $kontaks)
        <div id="editKontak{{ $kontaks->id_kontak }}"
            ...
            <div
                ...
                <form action="{{ route('kontak.update', $kontaks->id_kontak) }}" method="POST"
                            ...
                            <div>
                                <div class="mb-3">
                                    <label for="nama_kontak"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Nama Kontak</label>
                                    <input type="text" class="form-input" id="nama_kontak" name="nama_kontak"
                                        aria-describedby="nama_kontak" placeholder="Masukan Nama Kontak"
                                        value="{{ old('nama_kontak', $kontaks->nama_kontak) }}">
                                </div>
                            </div>
                            <div>
                                <div class="mb-3">
                                    <label for="jenis_kontak"
                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Jenis Kontak</label>
                                    <select id="jenis_kontak" name="jenis_kontak"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="" {{ $kontaks->jenis_kontak == '' ? 'selected' : '' }}>--
                                            Pilih Jenis Kontak --</option>
                                        <option value="pelanggan"
                                            {{ $kontaks->jenis_kontak == 'pelanggan' ? 'selected' : '' }}>Pelanggan
                                        </option>
                                        <option value="karyawan"
                                            {{ $kontaks->jenis_kontak == 'karyawan' ? 'selected' : '' }}>Karyawan</option>
                                        <option value="vendor" {{ $kontaks->jenis_kontak == 'vendor' ? 'selected' : '' }}>
                                            Vendor</option>
                                        <option value="lainnya"
                                            {{ $kontaks->jenis_kontak == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-input" id="nm_perusahaan" name="nm_perusahaan"
                                        ...
                                        value="{{ old('nm_perusahaan', $kontaks->nm_perusahaan) }}">
                                </div>
                            </div>
                            <div>
                                <div class="mb-3">
                                    ...
                                    <textarea id="alamat" name="alamat" rows="4"
                                        ...
                                        placeholder="Masukan Alamat">{{ old('alamat', $kontaks->alamat) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
