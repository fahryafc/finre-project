    ...
    <div class="card mt-10 p-5">
        <div class="card-header mb-5 flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <span>To</span>
                <input type="date" disabled class="border border-gray-300 rounded-md p-2" id="to_date" name="to_date"
            ...
            <select id="filter-jenis-pajak"
                class="border border-gray-300 rounded-md py-1 px-3 text-gray-700 dark:text-gray-200">
                                    ...
                                    @foreach ($pajak_ppn as $ppn)
                                        <tr class="pajak-row" data-jenis-pajak="{{ $ppn->jenis_pajak }}">
                                            ...
                                            @if ($ppn->jenis_pajak == 'Pajak Keluaran')
                                                <td>
                                                    <span
                                                        class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-green-500 text-white">{{ $ppn->jenis_pajak }}</span>
                                                </td>
                                            @else
                                                <td>
                                                    <span
                                                        class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-500 text-white">{{ $ppn->jenis_pajak }}</span>
                                                </td>
                                            @endif
