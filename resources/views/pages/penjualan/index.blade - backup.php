            ...
            <table id="penjualan-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @php
                            $total_harga = $p->harga * $p->kuantitas;
                            $totalHargaDiskon = $total_harga - $p->nominal_diskon;
                            $total_pemasukan = $totalHargaDiskon - $p->piutang + $p->ongkir;
                        @endphp
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{"Rp. ".number_format($total_pemasukan, 0, ".", ".") }}</td>
                        @csrf
                        @method('DELETE')
