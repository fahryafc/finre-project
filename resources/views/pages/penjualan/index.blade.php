                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                            ...
                            <button data-modal-target="modal-detail-jurnal" data-modal-toggle="modal-detail-jurnal" type="button" class="btn rounded-full bg-success/25 text-success hover:bg-success hover:text-white" data-id="{{ $p->id_penjualan }}">
